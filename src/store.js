  ...
  state: {
    ...
    routerList:[
      ...
      {routerName:'Solution',indexPath:'/Solution',value:'Solution',isActive:false,children:[
          {routerName:'SpaceSaver?type_id_1=10',indexPath:'/Solution/SpaceSaver',value:'Space Saver',isActive:false,children:[],id:''},
          {routerName:'EnergySaver?type_id_1=11',indexPath:'/Solution/EnergySaver',value:'Energy Saver',isActive:false,children:[]},
          {routerName:'SuperFlat?type_id_1=37',indexPath:'/Solution/SuperFlat',value:'Super Flat',isActive:false,children:[]},
          {routerName:'Desktop?type_id_1=38',indexPath:'/Solution/Desktop',value:'Desktop',isActive:false,children:[]},
          {routerName:'Living&Accessories?type_id_1=177',indexPath:'/Solution/Living&Accessories',value:'Living & Accessories',isActive:false,children:[]},
          {routerName:'Comfort?type_id_1=178',indexPath:'/Solution/Comfort',value:'Comfort',isActive:false,children:[]},
          {routerName:'One-The-Go?type_id_1=179',indexPath:'/Solution/One-The-Go',value:'One-The-Go',isActive:false,children:[]},
          {routerName:'Work?type_id_1=180',indexPath:'/Solution/routerName',value:'Work',isActive:false,children:[]},
          {routerName:'USBCharger?type_id_1=201',indexPath:'/Solution/USBCharger',value:'USB Charger',isActive:false,children:[]},
        ]
      },
